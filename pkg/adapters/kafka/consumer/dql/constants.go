...
var (
	...
	ErrConfigIsNil              = errors.New("consumer config is nil")
	ErrLoggerIsNil              = errors.New("consumer logger is nil")
	ErrExecDomainFuncIsNil      = errors.New("consumer domain exec function is nil")
	ErrTopicRequired            = errors.New("consumer topic is required")
	ErrGroupIDRequired          = errors.New("consumer group_id is required")
	ErrBrokersRequired          = errors.New("consumer brokers are required")
	ErrDLQSaverRequired         = errors.New("dlq saver is required when dlq save is enabled")
	...
	ErrMessageObjectTypePointer = errors.New("message object type must be a pointer")
...
const (
	...
	LogDLQSaveDisabledSkipPersist           = "DLQ save is disabled, failed messages will not be persisted"
	LogMessageCommitSkippedDLQDisabled      = "Kafka message commit skipped because DLQ save is disabled"
	LogMessageCommitSkippedPartitionBlocked = "Kafka message commit skipped because partition commit is blocked by previous failure"
	...
	LogConsumerGroupClosed                  = "Kafka consumer group closed"
	LogConsumerGroupCloseFailed             = "Failed to close Kafka consumer group"
)
